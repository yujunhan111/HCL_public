"""
Training script for Hierarchical Contrastive Learning (HCL) with varying sample size.

This script runs multiple repetitions of the HCL learning experiment over a range of
sample sizes, evaluating four methods: naive SVD, structure-based SVD, gradient-based,
and SLIDE.
"""
...
if __name__ == "__main__":
    ...
    # Initialize error storage: (methods, sample_sizes, repetitions, metrics)
    # 4 methods: SVD-naive, SVD-structured, Gradient, SLIDE
    # 13 sample sizes, 100 repetitions, 13 metrics each
